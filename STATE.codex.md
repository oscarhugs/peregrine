...
- 2026-09-26 — Fixed the chart renderer so dollar signs stay literal in all labels instead of being parsed as Matplotlib math text; added a regression test with two dollar signs in the title and caption. Six chart tests pass.
...
- Charts: `videos/001-red-lobster/charts/README.md` still tells readers to avoid two dollar signs in a label; Claude owns that pilot document and can remove the stale warning after this fix merges.
